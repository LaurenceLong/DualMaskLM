...
@dataclass
class DualMaskModelConfig(PretrainedConfig):
    """
    DualMaskLanguageModel的配置类。
    继承自PretrainedConfig以利用其save_pretrained/from_pretrained等功能。
    """
    model_type: str = "dualmask_custom_llama"
    ...
    tokenizer_save_dir: str = "tokenizer_dualmask_custom" # 保存自定义tokenizer的目录
    ...
    checkpoint_dir: str = "checkpoints_dualmask_custom" # 保存模型检查点的目录
...
# 使用示例:
# config = DualMaskModelConfig(vocab_size=32000, max_train_steps=50000)
# print(config)